...
export function NotFound() {
    return <main style={{display: 'flex', flexDirection: 'column', alignItems: 'center', height: '100vh', justifyContent: 'center'}}>
        ...
        <Link to='/' className="highlightedNav" style={{fontSize: '1.46vw', lineHeight: '1.46vw', paddingTop: '0.9375vw', textAlign: 'center'}} id="errorButton">Повернутися на головну</Link>
    </main>
}